...
class DBTests(PatchedConnectionTestsBase):
    ...
    def test__parse_connection_string_empty(self):
        ...
        self.assertNotIn('try_transactions', parsed)
        self.assertNotIn('mysql_lock', parsed)
        self.assertNotIn('db', parsed['kw_args'])
        self.assertNotIn('host', parsed['kw_args'])
        self.assertNotIn('port', parsed['kw_args'])
        self.assertNotIn('user', parsed['kw_args'])
        self.assertNotIn('passwd', parsed['kw_args'])
        self.assertNotIn('unix_socket', parsed['kw_args'])
        self.assertFalse(parsed['kw_args']['use_unicode'])
        self.assertNotIn('charset', parsed['kw_args'])
